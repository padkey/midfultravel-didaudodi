...
class EAVAttributeController extends AdminController
{
    ...
    {
        Permission::check('dtv.eav-attribute');
        ...
        $grid->actions(function (Grid\Displayers\Actions $actions) {
            if (!Admin::user()->can('dtv.eav-attribute.delete') || $actions->row->is_system) {
    ...
    {
        Permission::check('dtv.eav-attribute.create');
        return $content
            ->title($this->title())
    ...
    {
        Permission::check('dtv.eav-attribute.edit');
        return $content
            ->title($this->title())
    ...
    public function destroy($id)
    {
        try {
            if (!$this->eavAttribute->find($id)->is_system) {
                Permission::check('dtv.eav-attribute.delete');
